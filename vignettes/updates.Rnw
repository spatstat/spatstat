...
%#%^!ifndef ANTEDILUVIAN
  \item the original \spst package has now been split into 7 sub-packages
    (\pkg{spatstat.utils}, \pkg{spatstat.data}, \pkg{spatstat.sparse},
    \pkg{spatstat.geom}, \pkg{spatstat.core}, \pkg{spatstat.linnet}
    and \pkg{spatstat}).
%#%^!endif
  ...
  \item Important bug fix in simulation of log-Gaussian Cox processes.

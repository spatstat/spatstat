...
\item \texttt{F3est}:
   ...
   were wildly incorrect. 
     {\small (Bug was present since about 2010.
       Fixed in \texttt{spatstat 1.47-1}, december 2016)}
 ...
 \item \texttt{clip.infline}: 
   ...
   \bugger{1.15-1}{april 2009}{1.47-1}{december 2016}
 ...
 \item \texttt{integral.linim}, \texttt{integral.linfun}:
   results were slightly inaccurate because of a bias in the distribution of
   sample points.

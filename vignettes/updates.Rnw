...
\item \texttt{collapse.fv}:
 ...
 \item \texttt{nncross.lpp, distfun.lpp}:
   Computation accelerated.
 ...
 \item \texttt{rStrauss, rHardcore, rStraussHard, rDiggleGratton, rDGS, rPenttinen:}
   ...
   New options \texttt{fastthin} and \texttt{fastpois} enable fast simulation algorithms.
...
\item \texttt{triangulate.owin}:
   ...
   \bugger{1.42-2}{june 2015}{1.43-1}{december 2015}
...
\item \texttt{crosspairs}:
   ...
   \bugger{1.35-0}{december 2013}{1.43-1}{december 2015}
...
\item \texttt{Kest.fft}:
  Result was incorrectly normalised.
   \bugger{1.21-2}{january 2011}{1.43-1}{december 2015}

...
\item \texttt{density.ppp}:
  ...
  \texttt{at="points"} and \texttt{leaveoneout=FALSE}.
   \bugger{1.47-0}{october 2016}{1.56-2}{september 2018}   
...
\item \texttt{envelope.ppm}:
 ...
 \item \texttt{update.kppm}:
  ...
  \item \verb!as.im.function!:
    ...
    \bugger{1.42-0}{may 2015}{1.56-2}{october 2018}
...
\item \texttt{F3est}:
 ...
 \item \texttt{nnorient}:
   ...
   \bugger{1.40-0}{december 2015}{1.56-2}{october 2018}   
 \end{itemize}   

...
\item \texttt{F3est}:
 ...
 \item \texttt{quadrat.test}:
   ...
   \bugger{1.38-0}{august 2014}{1.60-1}{september 2019}
...
\item \texttt{anova.ppm}:
  ...
  \bugger{1.53-0}{september 2017}{1.60-2}{august 2019}
...
\item \verb!is.subset.owin!: sometimes gave the wrong result for polygonal
 ...
 \item \texttt{plot.tess}:  the legend showed the tile names
  ...
  \item \texttt{effectfun}:
    ...
    \bugger{1.52-0}{august 2017}{1.60-2}{august 2019}

  \item \verb!"[<-.hyperframe"!:
    Did not handlesome classes of objects correctly,
    \bugger{1.37-0}{may 2014}{1.60-2}{august 2019}
\end{itemize}

...
all recorded bugs in the \spst\ famil of packages.
...
all of these sub-packages. See the help for \texttt{bugfixes} for further details.
...
\item \texttt{envelope.ppm}:
 ...
 \item \texttt{vcov.mppm}:
   ...
   \bugger{1.45-1}{may 2016}{spatstat.core 2.4-1}{may 2022}   
